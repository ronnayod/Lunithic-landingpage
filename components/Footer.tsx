    ...
    <footer className="bg-[#0B1026] border-t border-[#6366F1]/10 pt-16 pb-8 px-4 sm:px-6 lg:px-8" aria-label="ส่วนท้ายเว็บไซต์">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          {/* Brand */}
          <div>
            <h3 className="text-2xl font-bold tracking-wider bg-gradient-to-r from-[#ffffff] to-[#ffffff] bg-clip-text text-transparent mb-4">
              LUNITHIC
            </h3>
          ...
          {/* Services */}
          <div>
            <h4 className="text-[#ffffff] font-semibold mb-4">บริการ</h4>
          ...
          {/* Company */}
          <div>
            <h4 className="text-[#ffffff] font-semibold mb-4">บริษัท</h4>
            <ul className="space-y-2.5">
          ...
          {/* Contact */}
          <div>
            <h4 className="text-[#ffffff] font-semibold mb-4">ติดต่อ</h4>
